...
public class Cat3Q1 extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cat3_q1);
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ansOne.isChecked()){
                    result.setText("Wrong! You must provoke him!");
                }
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Cat3Q1.this, MainActivity.class));
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Cat3Q1.this, Cat3Q2.class));
            }
        });
    }
