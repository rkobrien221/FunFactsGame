...
public class Cat1Q3 extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cat1_q3);
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ansOne.isChecked()){
                    ...
                    result.setText("Wrong! He wants you to be healthy");
                }
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Cat1Q3.this, Cat1Q2.class));
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Cat1Q3.this, MainActivity.class));
            }
        });
    }
